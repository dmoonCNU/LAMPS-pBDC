...
void bdcTimeDist_Data_v15(TString loc="~/Research_2023/202302HIMACBeamTest/AllData/1_Proton100MeV/Data", int RunNumber=2043){


	//int RunNumber = 360;
	/*
	   TFile* itf1 = new TFile("../220526_Cosmic_c1430_a1430_0C00_evt30k_PMTCoin_Delay180ns_expset_aBDCaASD_t106_ASD16.root","READ"); // X1-X1'
	   TFile* itf2 = new TFile("../220526_Cosmic_c1430_a1430_0C00_evt30k_PMTCoin_Delay180ns_expset_aBDCaASD_t106_ASD18.root","READ"); // Y1-Y1'
	   TFile* itf3 = new TFile("../220526_Cosmic_c1430_a1430_0C00_evt30k_PMTCoin_Delay180ns_expset_aBDCaASD_t106_ASD17.root","READ"); // X2-X2'
	   TFile* itf4 = new TFile("../220526_Cosmic_c1430_a1430_0C00_evt30k_PMTCoin_Delay180ns_expset_aBDCaASD_t106_ASD19.root","READ"); // Y2-Y2'
	 */
	/*
	   TFile* itf1 = new TFile(Form("../../DAQ/%d_ASD16.root",RunNumber),"READ"); // X1-X1'
	   TFile* itf2 = new TFile(Form("../../DAQ/%d_ASD18.root",RunNumber),"READ"); // Y1-Y1'
	   TFile* itf3 = new TFile(Form("../../DAQ/%d_ASD17.root",RunNumber),"READ"); // X2-X2'
	   TFile* itf4 = new TFile(Form("../../DAQ/%d_ASD18.root",RunNumber),"READ"); // Y2-Y2'
	 */
	TFile* itf1 = new TFile(Form("%s/%d_ASD16.root",loc.Data(),RunNumber),"READ"); // X1-X1'
	TFile* itf2 = new TFile(Form("%s/%d_ASD18.root",loc.Data(),RunNumber),"READ"); // Y1-Y1'
	TFile* itf3 = new TFile(Form("%s/%d_ASD17.root",loc.Data(),RunNumber),"READ"); // X2-X2'
	TFile* itf4 = new TFile(Form("%s/%d_ASD18.root",loc.Data(),RunNumber),"READ"); // Y2-Y2'
	...
	TFile *outfile = new TFile("tTrackTree_BDC_Run_Cosmic_CNU_1430_v15.root","RECREATE");
