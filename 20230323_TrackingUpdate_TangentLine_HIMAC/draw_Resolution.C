void draw_Resolution(){
    ...
    TFile *in2 = new TFile("bdcAnaTrack_Data_CNU_Cosmic_Run_getResolution_v11.root","READ");
//    in1 = new TFile("bdcAnaTrack_Data_CNU_Cosmic_Run_getResolution_v11_tight.root","READ");
//    in2 = new TFile("bdcAnaTrack_Data_CNU_Cosmic_Run_getResolution_v11_tight.root","READ");
...
//    TF1 *gaus = new TF1("gaus","gaus",-0.15,0.15);
    TF1 *gaus = new TF1("gaus","gaus",-0.60,0.60);
...
//    TF1 *gaus2 = new TF1("gaus2","gaus",-0.35,0.35);
    TF1 *gaus2 = new TF1("gaus2","gaus",-0.35,0.45);
