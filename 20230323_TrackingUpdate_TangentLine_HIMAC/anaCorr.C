...
*/
	...
	std::cout << "Suggested x : " << (gs1->GetParameter(1))*sqrt(2)-(gs1->GetParameter(2))*sqrt(2)*tmp << " ~ " << (gs1->GetParameter(1))*sqrt(2)+(gs1->GetParameter(2))*sqrt(2)*tmp << std::endl;
    ...
    TimeCorr11->GetXaxis()->SetTitle("time 1 (ns)");
    TimeCorr11->GetYaxis()->SetTitle("time 2 (ns)");
    TimeCorr11->GetXaxis()->SetRangeUser(0,300);//80
    TimeCorr11->GetYaxis()->SetRangeUser(0,300);//80
    TimeCorr11->Draw("colz");
    //TimeCorr11->Draw("surf1");
    //TimeCorr11->Draw("surflz");

	f1->SetParameter(0,(gs1->GetParameter(1))*sqrt(2)-tmp*(gs1->GetParameter(2))*sqrt(2));
	f2->SetParameter(0,(gs1->GetParameter(1))*sqrt(2));
	f3->SetParameter(0,(gs1->GetParameter(1))*sqrt(2)+tmp*(gs1->GetParameter(2))*sqrt(2));
	std::cout << f1->GetParameter(0) << std::endl;
	std::cout << f2->GetParameter(0) << std::endl;
	std::cout << f3->GetParameter(0) << std::endl;
	...
	std::cout << "Suggested x : " << (gs12->GetParameter(1))*sqrt(2)-(gs12->GetParameter(2))*sqrt(2)*tmp << " ~ " << (gs12->GetParameter(1))*sqrt(2)+(gs12->GetParameter(2))*sqrt(2)*tmp << std::endl;
    ...
    TimeCorr21->GetYaxis()->SetTitle("time 4 (ns)");
     TimeCorr21->GetXaxis()->SetRangeUser(0,300);//80
    TimeCorr21->GetYaxis()->SetRangeUser(0,300);//80
   TimeCorr21->Draw("colz");
    //TimeCorr12->Draw("surf1");
    //TimeCorr12->Draw("surflz");
	f1->SetParameter(0,(gs1->GetParameter(1))*sqrt(2)-(gs1->GetParameter(2))*sqrt(2)*tmp);
	f2->SetParameter(0,(gs1->GetParameter(1))*sqrt(2));
	f3->SetParameter(0,(gs1->GetParameter(1))*sqrt(2)+(gs1->GetParameter(2))*sqrt(2)*tmp);
	...
	std::cout << "Suggested x : " << (gs32->GetParameter(1))*sqrt(2)-(gs32->GetParameter(2))*sqrt(2)*tmp << " ~ " << (gs32->GetParameter(1))*sqrt(2)+(gs32->GetParameter(2))*sqrt(2)*tmp << std::endl;
    ...
    TimeCorr31->GetYaxis()->SetTitle("time 3 (ns)");
      TimeCorr31->GetXaxis()->SetRangeUser(0,300);//80
    TimeCorr31->GetYaxis()->SetRangeUser(0,300);//80
    TimeCorr31->Draw("colz");
    //TimeCorr12->Draw("surf1");
    //TimeCorr12->Draw("surflz");
	f1->SetParameter(0,(gs1->GetParameter(1))*sqrt(2)-tmp*(gs1->GetParameter(2))*sqrt(2));
