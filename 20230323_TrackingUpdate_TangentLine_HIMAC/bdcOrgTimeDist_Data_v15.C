...
void bdcOrgTimeDist_Data_v15(TString loc="~/Research_2023/202302HIMACBeamTest/AllData/1_Proton100MeV/Data", TString rmk="2043"){

	TFile *itf1 = new TFile(Form("%s/%s_ASD16.root",loc.Data(),rmk.Data()),"READ");
	TFile *itf2 = new TFile(Form("%s/%s_ASD18.root",loc.Data(),rmk.Data()),"READ");
	TFile *itf3 = new TFile(Form("%s/%s_ASD17.root",loc.Data(),rmk.Data()),"READ");
	TFile *itf4 = new TFile(Form("%s/%s_ASD18.root",loc.Data(),rmk.Data()),"READ");
