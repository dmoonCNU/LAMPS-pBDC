...
void bdcOrgTimeDist_Data_v15_ori(TString loc="~/Research_2023/202302HIMACBeamTest/AllData/1_Proton100MeV/Data", TString rmk="2043"){
	...
	TFile *outfile = new TFile("tTimeTree_BDC_Run_Cosmic_CNU_1430_Org_v15_ori.root","RECREATE");
