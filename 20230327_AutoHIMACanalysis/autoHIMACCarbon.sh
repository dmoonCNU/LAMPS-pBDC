...
#./autoBDC.sh 3067 2 1111111 1 7 true true 1.5 false -0.9612 0.022	# 1 sigma

# Default option without correlation cut
#./autoBDC.sh 3067 2 1111111 1 7 true false 1.5 true -0.9612 0.022	# 1 sigma

# Default option without correlation cnd angle cut
#./autoBDC.sh 3067 2 1111111 1 7 true false 1.5 false -0.9612 0.022	# 1 sigma
...
#./autoBDC.sh 3067 2 1111111 1 7 false true 1.5 true -0.9612 0.022		# 1 sigma (default)
...
#./autoBDC.sh 3067 2 1111111 1 7 true true 1 true -0.9612 0.022			# 1 sigma
#./autoBDC.sh 3067 2 1111111 1 7 true true 1.5 true -0.9612 0.022		# 1.5 sigma (default)
#./autoBDC.sh 3067 2 1111111 1 7 true true 2 true -0.9612 0.022			# 2 sigma

# angle cut and no png with correlation nsigma variation

#./autoBDC.sh 3067 2 1111111 1 7 false true 1 true -0.9612 0.022		# 1 sigma
#./autoBDC.sh 3067 2 1111111 1 7 false true 1.5 true -0.9612 0.022		# 1.5 sigma (default)
#./autoBDC.sh 3067 2 1111111 1 7 false true 2 true -0.9612 0.022		# 2 sigma
...
#./autoBDC.sh 3067 2 2111111 1 7 false true 1.5 true -0.9612 0.022		# QDCopt=2
#./autoBDC.sh 3067 2 1211111 1 7 false true 1.5 true -0.9612 0.022		# t0opt=2
#./autoBDC.sh 3067 2 1121111 1 7 false true 1.5 true -0.9612 0.022		# tdopt=2
#./autoBDC.sh 3067 2 1112111 1 7 false true 1.5 true -0.9612 0.022		# hitopt=2
#./autoBDC.sh 3067 2 1111211 1 7 false true 1.5 true -0.9612 0.022		# chopt=2
#./autoBDC.sh 3067 2 1111121 1 7 false true 1.5 true -0.9612 0.022		# centopt=2
#./autoBDC.sh 3067 2 1111112 1 7 false true 1.5 true -0.9612 0.022		# pedopt=2
