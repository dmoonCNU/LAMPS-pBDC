...
void bdcOrgTimeDist_Data(int locano=___LOCANO___, int minip=___MINIP___, int maxip=___MAXIP___, int tdopt=___TDOPT___, int hitopt=___HITOPT___, int chopt=___CHOPT___, int centopt=___CENTOPT___, int RunNumber=___RUNNUMBER___){
...
*/
	...
	TH1D* TimeDist1 = new TH1D("TimeDist1" ,"TimeDist1;TDC Time (ns);Number of TDC hits/event",300,0,300);
	TH1D* TimeDist2 = new TH1D("TimeDist2" ,"TimeDist2;TDC Time (ns);Number of TDC hits/event",300,0,300);
	TH1D* TimeDist3 = new TH1D("TimeDist3" ,"TimeDist3;TDC Time (ns);Number of TDC hits/event",300,0,300);
	TH1D* TimeDist4 = new TH1D("TimeDist4" ,"TimeDist4;TDC Time (ns);Number of TDC hits/event",300,0,300);

	TH1D* TimeDist11 = new TH1D("TimeDist11" ,"TimeDist1;TDC Time (ns);Number of TDC hits/event",300,0,300);
	TH1D* TimeDist21 = new TH1D("TimeDist21" ,"TimeDist2;TDC Time (ns);Number of TDC hits/event",300,0,300);
	TH1D* TimeDist31 = new TH1D("TimeDist31" ,"TimeDist3;TDC Time (ns);Number of TDC hits/event",300,0,300);
	TH1D* TimeDist41 = new TH1D("TimeDist41" ,"TimeDist4;TDC Time (ns);Number of TDC hits/event",300,0,300);

	TH1D* TimeDist12 = new TH1D("TimeDist12" ,"TimeDist1;TDC Time (ns);Number of TDC hits/event",300,0,300);
	TH1D* TimeDist22 = new TH1D("TimeDist22" ,"TimeDist2;TDC Time (ns);Number of TDC hits/event",300,0,300);
	TH1D* TimeDist32 = new TH1D("TimeDist32" ,"TimeDist3;TDC Time (ns);Number of TDC hits/event",300,0,300);
	TH1D* TimeDist42 = new TH1D("TimeDist42" ,"TimeDist4;TDC Time (ns);Number of TDC hits/event",300,0,300);
	...
	TFile *outfile = new TFile("tTimeTree_BDC_Run_Cosmic_CNU_1430_Org_v16.root","RECREATE");
