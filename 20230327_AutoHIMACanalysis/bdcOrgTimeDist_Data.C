...
void bdcOrgTimeDist_Data(int locano=2, int minip=-1, int maxip=10, int tdopt=1, int hitopt=1, int chopt=1, int centopt=1, int RunNumber=3067){
	...
	TH1D* TimeDist1 = new TH1D("TimeDist1" ,"TimeDist1;time;Hit",300,0,300);
	TH1D* TimeDist2 = new TH1D("TimeDist2" ,"TimeDist2;time;Hit",300,0,300);
	TH1D* TimeDist3 = new TH1D("TimeDist3" ,"TimeDist3;time;Hit",300,0,300);
	TH1D* TimeDist4 = new TH1D("TimeDist4" ,"TimeDist4;time;Hit",300,0,300);

	TH1D* TimeDist11 = new TH1D("TimeDist11" ,"TimeDist1;time;Hit",300,0,300);
	TH1D* TimeDist21 = new TH1D("TimeDist21" ,"TimeDist2;time;Hit",300,0,300);
	TH1D* TimeDist31 = new TH1D("TimeDist31" ,"TimeDist3;time;Hit",300,0,300);
	TH1D* TimeDist41 = new TH1D("TimeDist41" ,"TimeDist4;time;Hit",300,0,300);

	TH1D* TimeDist12 = new TH1D("TimeDist12" ,"TimeDist1;time;Hit",300,0,300);
	TH1D* TimeDist22 = new TH1D("TimeDist22" ,"TimeDist2;time;Hit",300,0,300);
