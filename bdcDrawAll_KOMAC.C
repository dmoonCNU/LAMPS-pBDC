...
void bdcDrawAll_KOMAC(){
  ...
  TFile* itf = new TFile("221221_BDCset221221_HV1440V_TrigPMTCoin_evt40k_t109_ASD16.root");
  ...
  TH2D* hisQDC1= new TH2D("hisQDC1","hisQDC1;time;QDC",12,0,12,800,200,800);
  TH2D* hisQDC2= new TH2D("hisQDC2","hisQDC2;time;QDC",12,0,12,800,200,800);
  ...
  TH1D* hIpTime = new TH1D("hIpTime",";ip;Counts",12,0,12);
  TH1D* hIpTimeQDC = new TH1D("hIpTimeQDC",";ip;QDC",12,0,12);
  TH2D* hIpTimeQDC2 = new TH2D("hIpTimeQDC2",";ip;QDC",12,0,12,500,0,1000);
  ...
  int minip = 0;
  int maxip = 4;
  double QDCcut = 0; //460; // 300 : 0800 ASD 16, 360 : 0C00 ASD 16
  ...
  gPad->SetLogz();
  hisQDC1->Draw("colz");
  lt1->DrawLatex(0.2, 0.9, Form("HV C-%d A-%d at ASD %d DAC : 0C00",HVv,HVv,ASDNo));
  ...
  can->SaveAs(Form("%d_Cosmic_c%d_a%d_0C00_evt30k_t106_ASD%d.png",nDate,HVv,HVv,ASDNo));
  ...
  //c1->SaveAs("test.png");
  c1->SaveAs(Form("cosmic_total_%d_%d.png",RunNo,ASDNo));
