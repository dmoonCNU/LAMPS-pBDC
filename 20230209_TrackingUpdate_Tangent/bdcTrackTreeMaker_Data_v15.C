...
void bdcTrackTreeMaker_Data_v15(int RunNumber = 561){
  ...
  TFile* itf2 = new TFile("../220526_Cosmic_c1430_a1430_0C00_evt30k_PMTCoin_Delay180ns_expset_aBDCaASD_t106_ASD18.root","READ");
  TFile* itf3 = new TFile("../220526_Cosmic_c1430_a1430_0C00_evt30k_PMTCoin_Delay180ns_expset_aBDCaASD_t106_ASD17.root","READ");
  TFile* itf4 = new TFile("../220526_Cosmic_c1430_a1430_0C00_evt30k_PMTCoin_Delay180ns_expset_aBDCaASD_t106_ASD19.root","READ");
        ...
        for(int j = 0; j < nX12; j++){
          for(int k = 0; k < nX21; k++){
            for(int l = 0; l < nX22; l++){
              ...
              TimeSum21->Fill(time2+time3);
              TimeSum31->Fill(time3+time4);
