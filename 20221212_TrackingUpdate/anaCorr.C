void anaCorr(){
    ...
    TH2F *TimeCorr32 = (TH2F*)in1->Get("TimeCorr32");
    ...
    TimeCorr11->GetXaxis()->SetRangeUser(0,80);
    TimeCorr11->GetYaxis()->SetRangeUser(0,80);
    ...
    TimeCorr32->GetXaxis()->SetTitle("time 2 (ns)");
    TimeCorr32->GetYaxis()->SetTitle("time 3 (ns)");
    TimeCorr32->Draw("colz");
    //TimeCorr12->Draw("surf1");
    //TimeCorr12->Draw("surflz");
    ...
    x1 = TimeCorr12->ProjectionX("x1",0,5,"");
    x2 = TimeCorr12->ProjectionX("x2",5,10,"");
    x3 = TimeCorr12->ProjectionX("x3",10,15,"");
    x4 = TimeCorr12->ProjectionX("x4",15,20,"");
    x5 = TimeCorr12->ProjectionX("x5",20,25,"");
    ...
    TH2F *TimeCorrR12 = (TH2F*)in1->Get("TimeCorrR12");
    TH2F *TimeCorrR32 = (TH2F*)in1->Get("TimeCorrR32");
    ...
    c3->cd(2);
    TF1 *gs1 = new TF1("gs1","gaus",30,80);
    hProjX11->Fit(gs1,"rm");
    hProjX11->Draw("");

    c3->SaveAs("plot_time_corr_rotate_X.png");


    TFile *in3 = new TFile("bdcAnaTrack_Data_CNU_Cosmic_Run_getResolution_v10.root","READ");
