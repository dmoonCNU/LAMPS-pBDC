...
void bdcTimeDist_Data_v16(){

  //int RunNumber = 360;

  TFile* itf1 = new TFile("../220526_Cosmic_c1430_a1430_0C00_evt30k_PMTCoin_Delay180ns_expset_aBDCaASD_t106_ASD16.root","READ"); // X1-X1'
  TFile* itf2 = new TFile("../220526_Cosmic_c1430_a1430_0C00_evt30k_PMTCoin_Delay180ns_expset_aBDCaASD_t106_ASD17.root","READ"); // Y1-Y1'
  TFile* itf3 = new TFile("../220526_Cosmic_c1430_a1430_0C00_evt30k_PMTCoin_Delay180ns_expset_aBDCaASD_t106_ASD18.root","READ"); // X2-X2'
  TFile* itf4 = new TFile("../220526_Cosmic_c1430_a1430_0C00_evt30k_PMTCoin_Delay180ns_expset_aBDCaASD_t106_ASD19.root","READ"); // Y2-Y2'
  ...
  TH2D* TimeCorrX1 = new TH2D("TimeCorrX1",";time;time",100,0,100,100,0,100);
  TH2D* TimeCorrX2 = new TH2D("TimeCorrX2",";time;time",100,0,100,100,0,100);
  TH2D* TimeCorrX3 = new TH2D("TimeCorrX3",";time;time",100,0,100,100,0,100);
  TH2D* TimeCorrY1 = new TH2D("TimeCorrY1",";time;time",100,0,100,100,0,100);
  TH2D* TimeCorrY2 = new TH2D("TimeCorrY2",";time;time",100,0,100,100,0,100);
  TH2D* TimeCorrY3 = new TH2D("TimeCorrY3",";time;time",100,0,100,100,0,100);

  TH1D* TimeSumX1 = new TH1D("TimeSumX1",";time;Counts",200,0,200);
  TH1D* TimeSumX2 = new TH1D("TimeSumX2",";time;Counts",200,0,200);
  TH1D* TimeSumX3 = new TH1D("TimeSumX3",";time;Counts",200,0,200);

  TH1D* TimeSumY1 = new TH1D("TimeSumY1",";time;Counts",200,0,200);
  TH1D* TimeSumY2 = new TH1D("TimeSumY2",";time;Counts",200,0,200);
  TH1D* TimeSumY3 = new TH1D("TimeSumY3",";time;Counts",200,0,200);
  ...
  //TFile *outfile = new TFile("tTrackTree_BDC_Run_Cosmic_CNU_1430_ForTime_v14.root","RECREATE");
  ...
  for( int ievt = minevt; ievt < maxevt; ievt++){
        ...
        for(int j = 0; j < nX12; j++){
          for(int k = 0; k < nX21; k++){
            for(int l = 0; l < nX22; l++){
              ...
              TimeCorrX1->Fill(time1,time2);
              TimeCorrX2->Fill(time2,time3);
              TimeCorrX3->Fill(time3,time4);
              TimeSumX1->Fill(time1+time2);
              TimeSumX2->Fill(time2+time3);
              TimeSumX3->Fill(time3+time4);
    ...
    if(nY11 > 0 && nY12 > 0 && nY21 > 0 && nY22 > 0) {
      allfiredEvt3++;
      //nY11 = 1; nY12 = 1; nY21 = 1; nY22 = 1;
      if(!(nY11==1 && nY12==1 && nY21==1 && nY22 ==1)) continue;
      //cout<<"nY11 : "<<nY11<<", nY12 : "<<nY12<<", nY21 : "<<nY21<<", nY22 : "<<nY22<<endl;
        ...
        for(int j = 0; j < nY12; j++){
          for(int k = 0; k < nY21; k++){
            for(int l = 0; l < nY22; l++){
              ...
              TimeCorrY1->Fill(time1,time2);
              TimeCorrY2->Fill(time2,time3);
              TimeCorrY3->Fill(time3,time4);
              TimeSumY1->Fill(time1+time2);
              TimeSumY2->Fill(time2+time3);
              TimeSumY3->Fill(time3+time4);
  ...
  for(int i=0;i<4;i++)
  {
    ...
    for(int nbin=1;nbin<160;nbin++)
    {
      ...
      TimeInt1[i]->Fill(nbin,num1);
      TimeInt2[i]->Fill(nbin,num2);
    }
  }
