void draw_Resolution(){
    ...
    TF1 *gaus = new TF1("gaus","gaus",-0.2,0.2);
    ...
    TF1 *gaus1 = new TF1("gaus1","gaus",-0.25,0.25);
    ...
    TF1 *gaus2 = new TF1("gaus2","gaus",-0.25,0.25);
    ...
    double res_x = sqrt(((sgm[0]+sgm[1])/2.0)*gaus2->GetParameter(2));

    TLatex *lt1 = new TLatex();
    lt1->SetNDC();
    lt1->SetTextSize(0.035);
    lt1->DrawLatex(0.2, 0.88, Form("Resolution : %0.3f (mm)", res_x));

    cout<<"Sigma 1 : "<<sgm[0]<<", Sigma 2 : "<<sgm[1]<<endl;
    cout<<"Sigma with 3 points : "<<gaus2->GetParameter(2)<<endl;
    cout<<"Resolution : "<<sqrt(((sgm[0]+sgm[1])/2.0)*gaus2->GetParameter(2))<<endl;
