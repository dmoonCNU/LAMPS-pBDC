...
double ped[64]={179.93,178.4,177.34,180.94,179.93,184.42,187.45,191.72,180.37,177.74,178.27,178.53,180.06,180.85,187.12,193.11,182.03,181.65,180.05,183.17,183.12,187.14,189.48,193.75,182.54,179.7,181.01,180.51,180.14,185.12,187.36,192.65,179.33,175.63,176.17,179.81,178.17,181.02,186.34,192.3,176.93,175.91,175,177.56,175.23,180.1,185.3,185.62,177.88,176.86,178.1,176.7,179.8,183.83,183.07,192.66,181.29,178.66,177.66,177.51,177.12,183.07,182.71,190.8};
  ...
  for( int ievt = inevt; ievt < itr->GetEntries(); ievt++){
    ...
    for( int ich = 0; ich < 64; ich++){
      ...
      for( int ip = 0; ip < nPoints; ip++){
        ...
        double tmpQDC=Data[ip*128+ich]-ped[ich]*100/nPoints;
        unsigned short ftt
          = ((trigTime & 0xFF00 ) >> 8 )
          + ((trigTime & 0x007F ) << 8 );
